<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.kh.admin.shop.item.model.vo.*, java.util.ArrayList" %> <% Item it = (Item)request.getAttribute("item"); ArrayList<ItemImg>
  list = (ArrayList<ItemImg
    >)request.getAttribute("list"); String noImage = "/resources/img/noimage.png"; %>
    <!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
