                ...
                <div class="modify only_pc">
                    ...
                    <input type="hidden" name="shipNo" value="<%= updateMS.getShipNo() %>">
                     ...
                     <%-- <input type="text" id=addrMain name="address" placeholder="기본 주소 입력" value=""> --%>
                        ...
                        <input type="text" id="addrSub" name="user_detail_address" placeholder="나머지 주소를 입력해주세요" value="<%= updateMS.getShipAddrInfo() %>" required>
                    </div>

                    <div class="field">
                        <div class="label_block">이름</div>
                        <input type="text" id="receiverName" name="name"  placeholder="이름을 입력해주세요" value="<%= updateMS.getShipName() %>" required>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="receiverPhone" name="mobileInp"  data-format="number" pattern="[0-9]*" inputmode="decimal" placeholder="번호를 입력해주세요" value="<%= updateMS.getPhone()%>" required>
                    </div>
