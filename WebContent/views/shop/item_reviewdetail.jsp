...
<head>
    ...
    <link rel="stylesheet" href="/WebContent/resources/css/shop/item_review_mymoodang.css">
    ...
    <script>
        function going(){
            window.parent.location.href = "http://127.0.0.1:5500/mykurly_review_register.html";
        }
    </script>
