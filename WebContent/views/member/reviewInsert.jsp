<!-- 2023-04-19 / reviewInsert.jsp 작성 / 이지환 /
<!-- 2023-04-20 /common.jsp 에 있는 공통적인 코드 삭제하고 그 부분을 뺀 내용들 넣음, review-insert.js 명을 reviewInsert.js 로 수정 -->
<!-- 파일명 review-insert.css 를 reviewInsert.css 로 수정 및 태그 매칭 개수 수정 
	/ 이지환
 -->
...
<html lang="en">
  <head>
    ...
    <!-- 2023-04-20 / review-insert.css 를 reviewInsert.css 로 수정 / 이지환 -->
    <link rel="stylesheet" href="/resources/css/board//reviewInsert.css">
