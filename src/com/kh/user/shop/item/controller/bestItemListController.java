 ...
 */
@WebServlet("/bestItemList.it")
public class bestItemListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public bestItemListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		endPage = startPage + pageLimit - 1;
		 ...
		 ArrayList<Item> list = new ItemService().selectBestItemList(pi);
		...
		request.getRequestDispatcher("views/shop/bestItemList.jsp").forward(request, response);
