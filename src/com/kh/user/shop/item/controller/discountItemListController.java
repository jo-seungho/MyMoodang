...
// 2023-04-17 조승호
/**
 * Servlet implementation class discountItemListController
 */
@WebServlet("/discountItemList.it")
public class discountItemListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public discountItemListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		endPage = startPage + pageLimit - 1;
		 ...
		 ArrayList<Item> list = new ItemService().selectDiscountItemList(pi);
		...
		request.getRequestDispatcher("views/shop/discountItemList.jsp").forward(request, response);
